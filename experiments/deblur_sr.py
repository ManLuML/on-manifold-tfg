...
Usage:
    # Deblur with JiT-B/16
    uv run python experiments/deblur_sr.py --task deblur --model jit-b-16 \
...
Output Structure:
    ...
    └── jit-b-16/heun/x/dps/         # Per-model experiment
        ├── config.json
...
def main(args):
    ...
    exp_output_dir = base_output_dir / output_name / sampling_method / guidance_space / guidance_mode
    exp_output_dir.mkdir(parents=True, exist_ok=True)

    # Get TFG preset for this task + mode
