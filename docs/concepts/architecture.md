...
|-------|-------|-------------|-------|-----------|------------------|------------|
| JiT-B/16 | 12 | 768 | 12 | 4.0 | 4 | 131M |
| JiT-B/32 | 12 | 768 | 12 | 4.0 | 4 | — |
| JiT-L/16 | 24 | 1024 | 16 | 4.0 | 8 | 459M |
| JiT-L/32 | 24 | 1024 | 16 | 4.0 | 8 | — |
| JiT-H/16 | 32 | 1280 | 16 | 4.0 | 10 | 953M |
| JiT-H/32 | 32 | 1280 | 16 | 4.0 | 10 | — |

Parameter counts are for the /16 variants used in the paper (JiT has more
parameters than a plain ViT of the same depth/width due to its SwiGLU FFN,
per-block adaLN modulation, and bottleneck patch embedding). The paper uses
**JiT-H/16 (953M)** for all headline results; see
[`CHECKPOINTS.md`](../../CHECKPOINTS.md) for the released checkpoints.
