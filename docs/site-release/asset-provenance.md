...
| Dimension curve | `figs/onmanifold_vs_dim.pdf`, `dbb5fdefdea5ab30210b5014f036c847e3a7df2dac2b9ca78ad13912bd7b474c`; render source `6c3c9a…693f6` | `onmanifold-vs-dim-720.{avif,webp,png}` | Poppler render at 220 DPI and resize. Displayed beside Figure 1(a) as the controlled quantitative evidence supporting the manifold mechanism; hidden below 480px where its labels would be too small, while the numeric result rail remains visible. |
...
| Strong-guidance model grids | JiT `6c3c9c…aca`, SiT `8c35f7…086d9`, DiT `869985…eb90` | `{jit,sit,dit}-failure-grid-{720,1400,2200}.{avif,webp,jpg}` and `{jit,sit,dit}-failure-mobile-640.{avif,webp,jpg}` | Desktop derivatives preserve the complete grid. Mobile derivatives use the same neutral first-five-column crop for every target so individual samples remain legible without cherry-picking different positions. The scroll sequence has target-specific alt text and prose. |
